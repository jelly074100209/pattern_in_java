...
import com.pattern.responsibility_chain.ConcreteHandlerA;
import com.pattern.responsibility_chain.ConcreteHandlerB;
import com.pattern.responsibility_chain.Handler;
...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         *   可处理一个请求的对象集合应被动态指定
         */
        System.out.println("----- responsibility_chain pattern -----");
